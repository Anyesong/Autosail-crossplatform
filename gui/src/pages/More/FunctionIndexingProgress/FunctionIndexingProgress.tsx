...
import ClearIndexingProgressSubtext from "./ClearIndexingProgressSubtext";
...
export function getProgressPercentage(
  progress: FunctionIndexingProgressUpdate["progress"],
) {
...
function FunctionIndexingProgress() {
  ...
  const [update, setUpdate] = useState<FunctionIndexingProgressUpdate>({
  ...
  useWebviewListener("functionIndexProgress", async (data) => {
    setUpdate(data);
  });
  ...
  useEffect(() => {
    if (!initialized) {
      ...
      ideMessenger.post("index/functionIndexingProgressBarInitialized", undefined);
      initialized = true;
    }
  }, []);
  ...
  useEffect(() => {
    ...
    ideMessenger.post("index/functionSetPaused", paused);
  }, [paused]);
