import type {
    FunctionArtifactType,
    EmbeddingsCacheResponse,
    FunctionIContinueServerClient,
  } from "../functionInterface.js";
  
  export class FunctionContinueServerClient implements FunctionIContinueServerClient {
    url: URL | undefined;
    ...
    public async getFromIndexCache<T extends FunctionArtifactType>(
      keys: string[],
      artifactId: T,
