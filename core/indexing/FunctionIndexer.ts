...
import { FunctionChunkIndex } from "./chunk/FunctionChunkIndex.js";
...
export class FunctionPauseToken {
    constructor(private _paused: boolean) {}
...
export class FunctionIndexer {
  ...
  public async chunkWrite(file: string): Promise<void> {
