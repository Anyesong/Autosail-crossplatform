import { Chunk, ChunkWithoutID, FunctionChunk } from "../../index.js";
...
import { basicChunker, basicFunctionChunker } from "./basic.js";
import { codeChunker } from "./functionCode.js";
...
async function* chunkDocumentWithoutId(
  ...
  yield* basicFunctionChunker(contents, maxChunkSize);
}
