import { ChunkWithoutID, FunctionChunk } from "../../index.js";
...
export async function* basicFunctionChunker(
  contents: string,
  maxChunkSize: number,
  ...
  for (const lt of lineTokens) {
    if (chunkTokens + lt.tokenCount > maxChunkSize - 5) {
      yield { content: chunkContent, startLine, endLine: currLine - 1, function_name: "", function_context: chunkContent, filepath: "", index: 0, digest: "" };
      chunkContent = "";
      chunkTokens = 0;
      startLine = currLine;
    }
